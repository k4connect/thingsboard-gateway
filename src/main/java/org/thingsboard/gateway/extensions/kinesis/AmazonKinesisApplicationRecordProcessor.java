...
public class AmazonKinesisApplicationRecordProcessor implements IRecordProcessor {
    ...
    public void processRecords(ProcessRecordsInput processRecordsInput) {
        ...
        try{
            ...
            LOG.error("Error with processing records {}",e);
        }
        ...
        for (Record record : records) {
            ...
            for (int i = 0; i < NUM_RETRIES; i++) {
                try {
                    ...
                    throw new Exception("ProcessSingleRecord failed with error {}", e);
                } finally{
    ...
    private void processSingleRecord(Record record) throws Exception {
        ...
        try {
            ...
            throw new Exception("ProcessBody failed with error {}", e);
        }
    }
